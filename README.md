...
执行步骤/      S1~S4 部署步骤、部署计划、各阶段验收记录、门禁材料包、检查清单、供应链清单
               **经验沉淀与踩坑总表**（跨阶段经验：六大主线 + 分主题踩坑 + 静默失效 12 条 + 判据陷阱 + 交付前检查清单）
...
| **新接手 / 复盘** | [`执行步骤/AI数据治理平台_单机版_经验沉淀与踩坑总表.md`](执行步骤/AI数据治理平台_单机版_经验沉淀与踩坑总表.md) | 六大主线结论、分主题踩坑与硬纪律、**静默失效 12 条**、判据与口径陷阱、入库脱敏经验、交付前检查清单 |
...
| v1.1 | 2026-09-21 | 新增《…单机版_经验沉淀与踩坑总表.md》指引：§3 目录结构补一行、§4 上手路径增"新接手 / 复盘"角色行（该文件汇总跨阶段经验、静默失效 12 条、判据陷阱与交付前检查清单）；同步 `AGENTS.md` §1 文档地图。**未改架构、组件清单与门禁判据** |
